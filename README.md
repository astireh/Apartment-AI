...
**AI-агент:**
Доступны варианты бронирования...

Также пользователь может продолжать диалог с изменением условий:
...
**Пользователь:**
А давай только до 12 миллионов

**AI-агент:**
Обновляет бюджет, сохраняя количество комнат.
